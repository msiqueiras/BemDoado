...
public class EntradaUtils {
    ...
    public static boolean lerRespostaBooleana(Scanner scanner) {
        String resposta = "";
        boolean valido = false;
        ...
        while (!valido) {
            try {
                ...
                if (resposta.equals("true") || resposta.equals("false")) {
                    ...
                    System.out.println("Erro: digite true ou false e tente novamente.");
                }
            } catch (Exception e) {
                System.out.println("Erro inesperado: " + e.getMessage() + " Tente novamente.");
            }
        ...
        return Boolean.parseBoolean(resposta);
    }
}
